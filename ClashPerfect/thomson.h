...
static Color mo5_palette[16] = {
        /*  0 ? Noir        */ {0, 0, 0},
        /*  1 ? Rouge       */ {0x08, 0x01, 0x80},
        /*  2 ? Vert        */ {0xa6, 0x10, 0x8b},
        /*  3 ? Jaune       */ {0xfa, 0x19, 0x10},
        /*  4 ? Bleu        */ {0x67, 0x2a, 0x48},
        /*  5 ? Magenta     */ {0x20, 0xa8, 0x2d},
        /*  6 ? Cyan        */ {0x8b, 0x59, 0x01},
        /*  7 ? Blanc       */ {0xa2, 0x6f, 0x02},
        /*  8 ? Gris        */ {0x7e, 0x7e, 0x7e},
        /*  9 ? Vieux rose  */ {0x96, 0x64, 0xfe},
        /* 10 ? Vert clair  */ {0xfb, 0x9d, 0x06},
        /* 11 ? Sable       */ {0xfc, 0x90, 0xfe},
        /* 12 ? Bleu ciel   */ {0x97, 0xf2, 0xff},
        /* 13 ? Magenta cl. */ {0xad, 0xfe, 0xb2},
        /* 14 ? Cyan clair  */ {0xfe, 0xff, 0x1b},
        /* 15 ? Orange      */ {255,255,255}};

static Color mo5_palette_0ld[16] = {
	/*  0 ? Noir        */ {0, 0, 0},
	/*  1 ? Rouge       */ {255, 0, 0},
	/*  2 ? Vert        */ {0, 255, 0},
	/*  3 ? Jaune       */ {255, 255, 0},
